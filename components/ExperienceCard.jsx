...
export default function ExperienceCard({ experience, index }) {
  return (
    <motion.div
      ...
      className="relative bg-gray-900/50 border border-neon-cyan/20 rounded-lg p-6 mb-6 hover:border-neon-cyan/50 hover:glow transition-all duration-300 group"
    >
      {/* Timeline Line */}
      ...
      <div className="pl-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
          <h3 className="text-2xl font-bold text-neon-cyan mb-2 md:mb-0">
            {experience.title}
          </h3>
